  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-ink-500 text-start">
      ...
      {/* Error Alert */}
      {errorMessage && (
        <div className="p-4 rounded-md bg-terracotta-50 text-terracotta-700 border border-terracotta-200 flex items-center space-s-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* 1. Export Membres */}
        <div className="card p-6 flex flex-col justify-between hover:border-sage-500 transition-colors">
          <div>
            <div className="flex items-center space-s-3 mb-4">
              <div className="p-3 bg-sage-100 text-sage-600 rounded-lg">
                <Users className="w-6 h-6" />
              </div>
              <div>
                <h3 className="font-semibold text-ink-900 text-start">
                  {t("reports.members_title", "Adhérents & Membres")}
                </h3>
                <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-sage-50 text-sage-700">
                  <FileSpreadsheet className="w-3 h-3 me-1" />
                  Excel (.xlsx)
                </span>
              </div>
            </div>
            <p className="text-sm text-ink-600 text-start mb-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center space-s-2 px-4 py-2.5 bg-sage-600 hover:bg-sage-700 disabled:opacity-50 text-white rounded-md text-sm font-medium transition-colors"
          >
        ...
        <div className="card p-6 flex flex-col justify-between hover:border-indigo-500 transition-colors">
          <div>
            <div className="flex items-center space-s-3 mb-4">
            ...
            <p className="text-sm text-ink-600 text-start mb-4">
              {t("reports.stock_desc", "Historique détaillé des entrées, sorties et transferts inter-entrepôts.")}
            </p>

            {/* Date Filters */}
            <div className="space-y-3 mb-6 bg-ink-50 p-3 rounded-md border border-ink-100">
              <div>
                <label className="block text-xs font-medium text-ink-700 text-start mb-1">
          ...
          <button
            ...
            className="w-full flex items-center justify-center space-s-2 px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white rounded-md text-sm font-medium transition-colors"
          >
            <Download className="w-4 h-4 me-1.5" />
            {loadingMap["stock"]
              ? t("common.loading", "Chargement...")
        ...
        <div className="card p-6 flex flex-col justify-between hover:border-aubergine-500 transition-colors">
          <div>
            <div className="flex items-center space-s-3 mb-4">
              <div className="p-3 bg-aubergine-100 text-aubergine-600 rounded-lg">
              ...
              <div>
                ...
                <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-aubergine-50 text-aubergine-700">
                  <FileSpreadsheet className="w-3 h-3 me-1" />
                  Excel (.xlsx)
                </span>
              </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center space-s-2 px-4 py-2.5 bg-aubergine-600 hover:bg-aubergine-700 disabled:opacity-50 text-white rounded-md text-sm font-medium transition-colors"
          >
            <Download className="w-4 h-4 me-1.5" />
            {loadingMap["sales"]
              ? t("common.loading", "Chargement...")
