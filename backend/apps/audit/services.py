...
def log_activity(
    *, cooperative: Cooperative, actor: Optional[Any], action: str,
    target_type: str = "", target_id: str = "", target_repr: str = "",
    ...
    return AuditLog.objects.create(
        cooperative=cooperative, actor=actor, action=action,
        target_type=target_type, target_id=str(target_id) if target_id else "",
        target_repr=target_repr, metadata=metadata or {}, ip_address=ip_address,
    )
