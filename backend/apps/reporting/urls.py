...
urlpatterns = [
    ...
    path("exports/stock-movements/", StockMovementsExportView.as_view(),
         name="export-stock-movements"),
    path("exports/sales-orders/", SalesOrdersExportView.as_view(),
         name="export-sales-orders"),
    path("exports/purchase-orders/", PurchaseOrdersExportView.as_view(),
    ...
    path("exports/accounting-journal/", AccountingJournalExportView.as_view(),
