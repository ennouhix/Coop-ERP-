...
class Member(TenantBaseModel):
    ...
    status = models.CharField(max_length=15, choices=MemberStatus.choices, default=MemberStatus.ACTIVE)
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=["cooperative", "member_number"], name="unique_member_number_per_cooperative"),
