...
urlpatterns = [
    ...
    path(
        "orders/<uuid:order_id>/confirm/", PurchaseOrderConfirmView.as_view(), name="order-confirm"
    ),
    path(
        "orders/<uuid:order_id>/receive/", PurchaseOrderReceiveView.as_view(), name="order-receive"
    ),
